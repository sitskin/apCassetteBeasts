...
cb_key_items = {
	...
	"Harbourtown Gate Key": CassetteBeastsItemData("key_harbourtown", id_off+5, IC.progression, 1, 1),
	...
	"Captain Wallace Stamp": CassetteBeastsItemData("ap_captain_wallace_stamp", id_off+13, IC.progression),
	"Captain Skip Stamp": CassetteBeastsItemData("ap_captain_skip_stamp", id_off+14, IC.progression),
	"Captain Zedd Stamp": CassetteBeastsItemData("ap_captain_zedd_stamp", id_off+15, IC.progression),
	"Captain Judas Stamp": CassetteBeastsItemData("ap_captain_judas_stamp", id_off+16, IC.progression),
	"Captain Clee-o Stamp": CassetteBeastsItemData("ap_captain_clee-o_stamp", id_off+17, IC.progression),
	"Captain Lodestein Stamp": CassetteBeastsItemData("ap_captain_lodestein_stamp", id_off+18, IC.progression),
	"Captain Penny Dreadful Stamp": CassetteBeastsItemData("ap_captain_penny_dreadful_stamp", id_off+19, IC.progression),
	"Captain Gladiola Stamp": CassetteBeastsItemData("ap_captain_gladiola_stamp", id_off+20, IC.progression),
	"Captain Heather Stamp": CassetteBeastsItemData("ap_captain_heather_stamp", id_off+21, IC.progression),
	"Captain Buffy Stamp": CassetteBeastsItemData("ap_captain_buffy_stamp", id_off+22, IC.progression),
	"Captain Cybil Stamp": CassetteBeastsItemData("ap_captain_cybil_stamp", id_off+23, IC.progression),
	"Captain Codey Stamp": CassetteBeastsItemData("ap_captain_codey_stamp", id_off+24, IC.progression),
	"Song Part (Oldgante)": CassetteBeastsItemData("aa_oldgante", id_off+25, IC.progression, 1, 1),
	"Song Part (Puppetox)": CassetteBeastsItemData("aa_puppet", id_off+26, IC.progression, 1, 1),
	"Song Part (Mourningstar)": CassetteBeastsItemData("aa_mourningstar", id_off+27, IC.progression, 1, 1),
	"Song Part (Nowhere Monarch)": CassetteBeastsItemData("aa_monarch", id_off+28, IC.progression, 1, 1),
	"Song Part (Heckahedron)": CassetteBeastsItemData("aa_cube", id_off+29, IC.progression, 1, 1),
	"Song Part (Alice)": CassetteBeastsItemData("aa_alice", id_off+30, IC.progression, 1, 1),
	"Song Part (Robin Goodfellow)": CassetteBeastsItemData("aa_robin", id_off+31, IC.progression, 1, 1),
	"Song Part (Mammon)": CassetteBeastsItemData("aa_mammon", id_off+32, IC.progression, 1, 1),
	"Song Part (Lamento Mori)": CassetteBeastsItemData("aa_lamento_mori", id_off+33, IC.progression, 1, 1),
	"Song Part (Babelith)": CassetteBeastsItemData("aa_tower", id_off+34, IC.progression, 1, 1),
