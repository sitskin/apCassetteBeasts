...
cb_key_items = {
	...
	"Captain Clee-o Stamp": CassetteBeastsItemData("ap_captain_clee-o_stamp", next(c), IC.progression),
	"Captain Lodestein Stamp": CassetteBeastsItemData("ap_captain_lodestein_stamp", next(c), IC.progression),
	"Captain Penny Dreadful Stamp": CassetteBeastsItemData("ap_captain_penny_dreadful_stamp", next(c), IC.progression),
	...
	"Song Part (Gwenivar)": CassetteBeastsItemData("aa_gwenivar", next(c), IC.progression, 1, 1,
